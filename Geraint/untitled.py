...
# roc_auc as the primary metric since churn is imbalanced (~26.5% positive class);
# accuracy alone would reward a model that just predicts "no churn" for everyone.
# f1 and average_precision reported too so you can compare trade-offs afterward.
scoring = {
    "roc_auc": "roc_auc",
    "f1": "f1",
